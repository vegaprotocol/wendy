...
// Mempool is an ordered in-memory pool for transactions before they are
...
type Mempool struct {
	...
	metrics *tmmempl.Metrics
}

var _ tmmempl.Mempool = &Mempool{}
...
func (mem *Mempool) isFull(txSize int) error {
	var (
		memSize  = mem.Size()
...
func (mem *Mempool) resCbFirstTime(
	tx []byte,
	peerID uint16,
	peerP2PID p2p.ID,
	res *abci.Response,

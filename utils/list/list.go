...
func (l *List) Each(fn FilterFunc) {
...
func (l *List) First(fn FilterFunc) *list.Element {
...
func (l *List) DiscardFirst(fn FilterFunc) bool {
	e := l.First(fn)
	if e != nil {
		l.List.Remove(e)
		return true
...
func (l *List) Discard(fn FilterFunc) int {
	var count int
	l.Each(func(e *list.Element) bool {
		if match := fn(e); match {
			count++
...
// FilterFunc fn.
func (l *List) All(fn FilterFunc) *List {
	var all = New()
	l.Each(func(e *list.Element) bool {
		if fn(e) {
